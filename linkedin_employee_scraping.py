...
def login():
    ...
    driver.find_element(by=By.XPATH, value="//input[@type='text']").send_keys("yukendiran.k@ideas2it.com")
    driver.find_element(by=By.XPATH, value="//input[@type='password']").send_keys("Yuki@2001")
